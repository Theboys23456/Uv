...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7897474464:AAFWfrC39t0dIG9_wdzJgvmUiBUHBIc3NXQ")

CREDIT = os.environ.get("CREDIT", "〱STRANGER▕")
# MongoDB Configuration
DATABASE_NAME = os.environ.get("DATABASE_NAME", "UGxPRO")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://ugbot31:ugbot1234@cluster0.n1uexk5.mongodb.net/UGxPRO?retryWrites=true&w=majority&appName=Cluster0")
...
PREMIUM_CHANNEL = "https://t.me/+OI2yHhvzFSkzNWZl"
# Thumbnail Configuration
THUMBNAILS = list(map(str, os.environ.get("THUMBNAILS", "https://i.ibb.co/7xm7cXyg/STRANGER-BOY.jpg").split()))
